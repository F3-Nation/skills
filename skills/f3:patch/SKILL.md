...
- `/f3:patch scan` -- scan changed files + full dep audit
- `/f3:patch scan packages/api/src` -- scan specific path
- `/f3:patch scan --output report.json` -- scan and save report
- `/f3:patch pentest http://localhost:3000` -- run ZAP against local app
- `/f3:patch pentest http://localhost:3000 --output zap-report.json`
- `/f3:patch setup-ci` -- scaffold security CI workflow
