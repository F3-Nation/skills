...
Locate and read the shared rules file via Glob for `**/skills/_shared/f3-react-rules.md`. These 8 rules are the shared React/Next.js code quality baseline used across all `/f3:*` skills.
...
Shared rules:   8 loaded from f3-react-rules.md
